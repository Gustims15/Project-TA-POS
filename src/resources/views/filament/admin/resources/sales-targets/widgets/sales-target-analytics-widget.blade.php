        ...
        <section class="ng-target-hero-grid">
            ...
            <article class="ng-widget-card ng-target-highlight-card">
                <div class="ng-highlight-info">
                    ...
                    <strong>{{ $summary['latest_target_month'] ?? '-' }}</strong>
                    <small>{{ $this->rupiah($summary['latest_target_value'] ?? 0) }}</small>
                </div>
        ...
        <section class="ng-widget-card ng-target-progress-card">
            <div class="ng-target-progress-head">
                <div>
                    ...
                    <strong>{{ $summary['revenue_progress'] ?? 0 }}%</strong>
                </div>

                <small>
                    Aktual {{ $this->rupiah($summary['monthly_revenue'] ?? 0) }}
                    dari target {{ $this->rupiah($summary['target_revenue'] ?? 0) }}
                </small>
            </div>
