    ...
    <div class="revenue-page">
        <div class="report-hero">
            <div class="hero-content">
                ...
                <form method="GET" action="{{ request()->url() }}" class="month-panel">
                ...
                <div class="table-card-header-content">
                    <div>
                        <h3 class="table-title">
                            Data Order Bulan {{ $selectedMonthLabel }}
                        </h3>
                    ...
                    <div class="table-pill">
                        Total Data
                        <strong>{{ number_format($summary['total_orders'], 0, ',', '.') }}</strong>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="empty-state">
                                        ...
                                        <p class="empty-desc">
                                            Tidak ada transaksi selesai pada bulan {{ $selectedMonthLabel }}.
                                        </p>
                                    </div>
                                </td>
                            </tr>
                    ...
                    @if ($orders->count() > 0)
                        <tfoot>
                            <tr>
                                ...
                                <td>{{ number_format($summary['total_items'], 0, ',', '.') }}</td>
