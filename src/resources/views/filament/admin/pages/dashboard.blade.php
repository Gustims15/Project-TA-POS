        ...
        <section class="ng-dashboard-header">
            ...
            <div class="ng-filter-area">
                <div class="ng-period-tabs">
                    <a
                        href="{{ request()->fullUrlWithQuery(['period' => 'today', 'month' => null]) }}"
                    ...
                    <a
                        href="{{ request()->fullUrlWithQuery(['period' => 'week', 'month' => null]) }}"
                    ...
                    <a
                        href="{{ request()->fullUrlWithQuery(['period' => 'month', 'month' => null]) }}"
                    ...
                    <a
                        href="{{ request()->fullUrlWithQuery(['period' => 'year', 'month' => 'all']) }}"
                ...
                @if ($activePeriod === 'year')
                    <form method="GET" action="{{ request()->url() }}" class="ng-month-form">
