        ...
        <div class="heatmap-pbi">
            <div class="heatmap-pbi-head">
                <div>
                    ...
                    <p class="heatmap-pbi-subtitle">
                        Intensitas <?php echo e(strtolower($metricLabel)); ?> berdasarkan hari dan jam.
                    </p>
                </div>
            ...
            <div class="heatmap-insights">
                <div class="heatmap-insight-box">
                    ...
                    <div class="heatmap-insight-value"><?php echo e($insights['peak_day']); ?></div>
                </div>

                <div class="heatmap-insight-box">
                    <div class="heatmap-insight-label">Peak Hour</div>
                    <div class="heatmap-insight-value"><?php echo e($insights['peak_hour']); ?></div>
                </div>

                <div class="heatmap-insight-box">
                    <div class="heatmap-insight-label">Peak Value</div>
                    <div class="heatmap-insight-value"><?php echo e($insights['peak_value']); ?></div>
                </div>

                <div class="heatmap-insight-box">
                    <div class="heatmap-insight-label">Quiet Time</div>
                    <div class="heatmap-insight-value">
                        <?php echo e($insights['quiet_day']); ?> <?php echo e($insights['quiet_hour']); ?>
            ...
            <div class="heatmap-pbi-footer">
                <span><?php echo e($metricLabel); ?> intensity</span>
