        ...
        <section class="ng-role-form-hero-grid">
            ...
            <article class="ng-widget-card ng-role-form-highlight-card">
                <div class="ng-highlight-info">
                    ...
                    <strong>
                        <?php echo e(number_format((int) ($stats['total_permissions'] ?? 0), 0, ',', '.')); ?>

                    </strong>

                    <small>
                        <?php echo e(number_format((int) ($stats['total_roles'] ?? 0), 0, ',', '.')); ?>

                        role sistem •
                        <?php echo e(number_format((int) ($stats['web_roles'] ?? 0), 0, ',', '.')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/filament/admin/resources/roles/widgets/role-form-hero-widget.blade.php ENDPATH**/ ?>