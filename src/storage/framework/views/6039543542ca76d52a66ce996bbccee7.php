        ...
        <section class="category-lux-hero">
            <div class="category-lux-hero-top">
                ...
                <div class="category-lux-mini">
                    ...
                    <small>
                        <?php echo e(number_format($summary['top_category_products'], 0, ',', '.')); ?> produk
                    </small>

                    <a
                        href="<?php echo e(\App\Filament\Admin\Resources\Categories\CategoryResource::getUrl('create')); ?>"
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/filament/admin/resources/categories/widgets/category-analytics-widget.blade.php ENDPATH**/ ?>