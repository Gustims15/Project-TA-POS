<?php
    $cards = [
        [
            ...
            'value' => $this->rupiah($summary['target_revenue']),
            'caption' => $summary['has_current_target'] ? 'Target aktif bulan ini' : 'Belum ada target bulan ini',
            'icon' => '⚑',
            'color' => '#f97316',
        ],
        [
            'label' => 'Revenue Aktual',
            'value' => $this->rupiah($summary['monthly_revenue']),
        ...
        [
            ...
            'value' => $summary['revenue_progress'] . '%',
        ...
        [
            ...
            'value' => $this->rupiah($summary['year_target_revenue']),
        ...
        [
            'label' => 'Total Target',
            'value' => number_format($summary['total_targets'], 0, ',', '.'),
    ...
    $progressWidth = max(0, min(100, (float) $summary['revenue_progress']));
?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="ng-sales-target-page" style="
        width: 100%;
        ...
        ">
            ...
            ">
                <div style="min-width: 0;">
                    ...
                    ">
                        <?php echo e($summary['latest_target_month']); ?>
                    ...
                    <small style="
                        ...
                        font-weight: 850;
                    ">
                        <?php echo e($this->rupiah($summary['latest_target_value'])); ?>
        ...
        ">
            ...
            ">
                <span style="
                    ...
                    font-weight: 900;
                ">
                    Progress Target Revenue Bulan Ini
                </span>
                ...
                <strong style="
                    ...
                    font-weight: 950;
                ">
                    <?php echo e($summary['revenue_progress']); ?>%
                </strong>
            </div>
            ...
            ">
                <i style="
                    display: block;
                    width: <?php echo e($progressWidth); ?>%;
                    height: 100%;
    ...
    <style>
        ...
        body:has(.ng-sales-target-page) .ng-sales-target-page {
            padding-bottom: 12px !important;
        }

        body:has(.ng-sales-target-page) .ng-sales-target-page > div:last-of-type {
        ...
        @media (max-width: 1500px) {
            .ng-sales-target-page [style*="grid-template-columns: repeat(5"] {
                grid-template-columns: repeat(3, minmax(0, 1fr)) !important;
            }

            .ng-sales-target-page [style*="grid-template-columns: minmax(0, 1.35fr)"] {
        ...
        @media (max-width: 900px) {
            ...
            .ng-sales-target-page [style*="grid-template-columns: repeat(5"] {
                ...
                /* =========================================================
        FINAL FIX TARGET PENJUALAN - RAPATKAN TABLE KE WIDGET ATAS
        Scope hanya halaman Target Penjualan
        ========================================================= */
        ...
        /* Progress bar terakhir jangan kasih jarak bawah */
        body:has(.ng-sales-target-page) .ng-sales-target-page > div:last-of-type {
            margin-bottom: -8px !important;
        }

        /* Table dinaikkan sedikit tapi tidak sampai nabrak */
        body:has(.ng-sales-target-page) .fi-ta-ctn {
        ...
        /* Area atas table yang kosong dipendekkan */
        body:has(.ng-sales-target-page) .fi-ta-header,
        body:has(.ng-sales-target-page) .fi-ta-toolbar {
            min-height: 44px !important;
        ...
        /* Kalau ada wrapper tambahan dari Filament */
        body:has(.ng-sales-target-page) .fi-ta {
            margin-top: 0 !important;
        }

        /* Header kolom lebih rapat */
        body:has(.ng-sales-target-page) .fi-ta-header-cell {
            padding-top: 8px !important;
            padding-bottom: 8px !important;
        }
        ...
        /* Pagination jangan terlalu tinggi */
        body:has(.ng-sales-target-page) .fi-ta-pagination,
        body:has(.ng-sales-target-page) .fi-pagination {
            min-height: 46px !important;
            padding-top: 8px !important;
