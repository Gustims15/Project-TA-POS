...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="ng-sales-target-form-page">
        <section class="ng-target-form-hero-grid">
            ...
            <article class="ng-widget-card ng-target-form-highlight-card">
                <div class="ng-highlight-info">
                    <span>Target Bulan Ini</span>

                    <strong>
                        <?php echo e($this->rupiah($stats['current_target_revenue'] ?? 0)); ?>

                    </strong>

                    <small>
                        <?php echo e(number_format((int) ($stats['total_targets'] ?? 0), 0, ',', '.')); ?> target tersimpan
                        • Tahun ini <?php echo e($this->rupiah($stats['year_target_revenue'] ?? 0)); ?>
    ...
    <style>
        ...
        */
        ...
        body:has(.ng-sales-target-form-page) .fi-toggle {
