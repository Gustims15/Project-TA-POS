    ...
    <div class="product-lux-wrapper">
        <section class="product-lux-hero">
            <div class="product-lux-hero-top">
                ...
                <div class="product-lux-mini">
                    ...
                    <strong><?php echo e(number_format($summary['total_stock'], 0, ',', '.')); ?></strong>
                </div>
            </div>
        </section>
        ...
        <div class="product-lux-grid">
            ...
            <div class="product-lux-card active">
                ...
                <p class="product-lux-card-value">
                    <?php echo e(number_format($summary['active_products'], 0, ',', '.')); ?>
            ...
            <div class="product-lux-card stock">
                ...
                <p class="product-lux-card-value">
                    <?php echo e(number_format($summary['out_of_stock_products'] + $summary['low_stock_products'], 0, ',', '.')); ?>

                </p>
                <p class="product-lux-card-caption">
                    <?php echo e(number_format($summary['out_of_stock_products'], 0, ',', '.')); ?> habis,
                    <?php echo e(number_format($summary['low_stock_products'], 0, ',', '.')); ?> menipis
                </p>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/filament/admin/resources/products/widgets/product-analytics-widget.blade.php ENDPATH**/ ?>