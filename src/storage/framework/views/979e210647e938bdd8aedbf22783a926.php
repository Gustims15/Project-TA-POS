<?php
    ...
    $cards = [
        [
            'label' => 'Total Users',
            'value' => number_format((int) ($summary['total_users'] ?? 0), 0, ',', '.'),
        ...
        [
            'label' => 'Super Admin',
            'value' => number_format((int) ($summary['super_admins'] ?? 0), 0, ',', '.'),
        ...
        [
            'label' => 'Karyawan',
            'value' => number_format((int) ($summary['karyawan'] ?? 0), 0, ',', '.'),
            'caption' => 'Akses kasir',
            'icon' => '◇',
            'color' => '#3b82f6',
        ],
        [
            'label' => 'User Baru',
            'value' => number_format((int) ($summary['new_users'] ?? 0), 0, ',', '.'),
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="ng-user-page">
        <section class="ng-user-hero-grid">
            <article class="ng-widget-card ng-user-hero-card">
                <div class="ng-widget-head">
                    <div>
                        <h1>User Management</h1>

                        <p>
                            Kelola akun pengguna sistem, role akses, super admin, dan karyawan
                            yang memiliki akses ke sistem POS UMKM Ngunjuk.
                        </p>
                    </div>
                </div>
            </article>
            ...
            <article class="ng-widget-card ng-user-highlight-card">
                <div class="ng-highlight-info">
                    ...
                    <b>
                        <?php echo e($summary['latest_user_role'] ?? '-'); ?>
        ...
        <section class="ng-kpi-grid ng-user-kpi-grid">
    ...
    <style>
        ...
        */
        ...
        body:has(.ng-user-page) .fi-ta-ctn > div,
        body:has(.ng-user-page) .fi-ta-ctn > div > div,
        body:has(.ng-user-page) .fi-ta-ctn > div > div > div,
        body:has(.ng-user-page) table,
        body:has(.ng-user-page) thead,
        body:has(.ng-user-page) tbody,
        body:has(.ng-user-page) tr,
        body:has(.ng-user-page) th,
        body:has(.ng-user-page) td {
            background: transparent !important;
            box-shadow: none !important;
        }
        ...
        body:has(.ng-user-page) .fi-btn-color-warning {
        ...
        */
        ...
        body:has(.ng-user-page) .fi-sidebar-item-active svg,
        body:has(.ng-user-page) .fi-sidebar-item a:hover svg,
        body:has(.ng-user-page) .fi-sidebar-item-active span,
        body:has(.ng-user-page) .fi-sidebar-item a:hover span {
            color: #fff !important;
        }
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/filament/admin/resources/users/widgets/user-analytics-widget.blade.php ENDPATH**/ ?>