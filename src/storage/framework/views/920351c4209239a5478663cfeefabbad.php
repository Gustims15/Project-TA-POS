    ...
    <div class="ng-category-form-page">
        <section class="ng-category-form-hero">
            <div class="ng-category-form-title">
                ...
                <a href="<?php echo e($backUrl); ?>" class="ng-category-back-btn">
                    ← Kembali
                </a>
            </div>
        </section>
        ...
        <section class="ng-category-form-stats">
            ...
            <article>
                ...
                <strong><?php echo e(number_format($stats['active_categories'], 0, ',', '.')); ?></strong>
...
<?php endif; ?><?php /**PATH /var/www/html/resources/views/filament/admin/resources/categories/widgets/category-form-hero-widget.blade.php ENDPATH**/ ?>