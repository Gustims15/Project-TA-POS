...
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="ng-form-error"><?php echo e($message); ?></span>
                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="ng-select-all-box">
                    <button
                        ...
                        class="ng-toggle-button <?php echo e($allSelected ? 'is-active' : ''); ?>"
                    ...
                    <div class="ng-toggle-copy">
                        ...
                        <span>
                            <?php echo e($this->selectedPermissionCount); ?> / <?php echo e($this->totalPermissionCount); ?>
            ...
            <div class="ng-permission-tabs-shell">
                <div class="ng-permission-tabs">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tabKey => $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <button
                            type="button"
                            wire:click="$set('activePermissionTab', '<?php echo e($tabKey); ?>')"
                            class="ng-tab-button <?php echo e($activeTabKey === $tabKey ? 'is-active' : ''); ?>"
                        >
                            <?php echo e($tab['label']); ?>

                            <span class="ng-tab-count"><?php echo e($tab['count']); ?></span>
                        </button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            </div>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($activeTab['groups'])): ?>
                <div class="ng-empty-permission">
                    Tidak ada permission pada tab ini.
                </div>
            <?php else: ?>
                <div class="ng-permission-groups-grid">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $activeTab['groups']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <?php
                            ...
                            <div class="ng-permission-group-head">
                                ...
                                <div class="ng-group-control">
                                    <span class="ng-group-count">
                                        <?php echo e($selectedCount); ?>/<?php echo e(count($permissionNames)); ?>

                                    </span>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isGroupFull): ?>
                                        <button
                                            type="button"
                                            class="ng-mini-button"
                                            wire:click="deselectGroupPermissions(<?php echo \Illuminate\Support\Js::from($permissionNames)->toHtml() ?>)"
                                        >
                                            Deselect all
                                        </button>
                                    <?php else: ?>
                                        <button
                                            type="button"
                                            class="ng-mini-button"
                                            wire:click="selectGroupPermissions(<?php echo \Illuminate\Support\Js::from($permissionNames)->toHtml() ?>)"
                                        >
                                            Select all
                                        </button>
                            ...
                            <div class="ng-permission-actions">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $group['permissions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    <label class="ng-permission-option">
                                        ...
                                        <span><?php echo e($permission['label']); ?></span>
                                    </label>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </div>
                        </article>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="ng-form-actions">
                <button type="submit" class="ng-primary-button">
                    <?php echo e($submitLabel ?? 'Simpan Role'); ?>

                </button>

                <a href="<?php echo e(\App\Filament\Admin\Resources\Roles\RoleResource::getUrl('index')); ?>" class="ng-soft-button">
                    Batal
                </a>
            </div>
        </div>
...
<?php /**PATH /var/www/html/resources/views/filament/admin/resources/roles/pages/partials/custom-role-form.blade.php ENDPATH**/ ?>