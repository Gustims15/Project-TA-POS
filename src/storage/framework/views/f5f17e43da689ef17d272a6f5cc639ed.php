...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="ng-operational-form-page" style="
        width: 100%;
        ...
        ">
            ...
            ">
                <div style="min-width: 0;">
                    ...
                    ">
                        <?php echo e($this->rupiah($stats['monthly_cost'])); ?>
                    ...
                    <small style="
                        ...
                        font-weight: 850;
                    ">
                        <?php echo e(number_format($stats['active_costs'], 0, ',', '.')); ?> biaya aktif dari <?php echo e(number_format($stats['total_costs'], 0, ',', '.')); ?> total data
                    </small>
                </div>
    ...
    <style>
        ...
        @media (max-width: 1500px) {
            .ng-operational-form-page [style*="grid-template-columns: minmax(0, 1.35fr)"] {
        ...
        @media (max-width: 900px) {
            .ng-operational-form-page {
                ...
                /* =========================================================
        FINAL FIX FORM BIAYA OPERASIONAL - NAIKAN KOLOM FORM
        Scope hanya halaman Create/Edit Biaya Operasional
        ========================================================= */
        ...
        /* Kalau Filament masih kasih wrapper section berjarak */
        body:has(.ng-operational-form-page) form .fi-section {
            margin-top: 0 !important;
        }

        /* Rapatkan area actions tombol bawah */
